...
class graphmonthserverinfo extends Command {
    constructor() {
        super({
            name: 'graphmonthserverinfo',
            category: 'stats',
            description: 'Cette commande donne les stats du bot sous forme de graph!',
            usage: 'graphmonthsi',
            example: ['graphmonthsi','gmsi'],
            aliases: ['gmsi','graphmonthsi']
        });
    }
  ...
  datasets: [
    {
    label:"Statistiques du mois sur " + message.guild.name,
  ...
  options: {
   legend: {
     ...
     title: {
            ...
            fontSize: 20,
            fontColor: "#fff",
            text: "Statistiques du mois sur " + message.guild.name
        },
    scales:{
        pointLabels: {
            fontSize: 20,
...
module.exports = new graphmonthserverinfo;