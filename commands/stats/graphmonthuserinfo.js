...
class graphmonthuserinfo extends Command {
    constructor() {
        super({
            name: 'graphmonthuserinfo',
            category: 'stats',
            description: 'Cette commande donne les stats du bot sous forme de graph!',
            usage: 'graphmonthui [@user]',
            example: ['graphmonthui @user','gmui'],
            aliases: ['gmui','graphmonthui']
        });
    }
    /*
  ...
  datasets: [
    {
    label:"Statistiques du mois pour " + message.author.username,
  ...
  options: {
    legend: {
     ...
     title: {
            ...
            fontSize: 20,
            fontColor: "#fff",
            text: "Statistiques du mois pour " + user.username
        },
    scales:{
        pointLabels: {
                            fontSize: 20,
...
module.exports = new graphmonthuserinfo;